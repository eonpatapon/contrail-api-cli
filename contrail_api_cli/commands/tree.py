...
class Tree(Command):
    ...
    .. code-block:: bash
        ...
        localhost:/> tree -r service-instance/f8e191c5-83fa-47f1-a242-e8ad7cab46c0
        ...
        admin@localhost:/> tree routing-instance/f792b52d-ff69-487e-b2a5-c13060e3ce77
    ...
    reverse = Option('-r',
                     help="Show tree of back references / children",
